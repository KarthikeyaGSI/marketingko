...
function ContactForm() {
  ...
  return (
    <motion.div
      ...
      className="p-8 md:p-20 rounded-[3rem] md:rounded-[4rem] border border-border bg-foreground/[0.02] backdrop-blur-3xl space-y-12 shadow-2xl relative overflow-hidden group"
    >
      ...
      <div className="space-y-10 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <Input placeholder="Karthikeya" className="h-16 md:h-20 px-8 rounded-2xl bg-background border-border focus:border-primary focus:ring-primary text-lg font-bold tracking-tight shadow-inner" />
          </div>
          <div className="space-y-4">
            <label className="text-[10px] font-black text-foreground/60 uppercase tracking-[0.3em] ml-4 italic">Business_Name *</label>
            <Input placeholder="Marketing Ko" className="h-16 md:h-20 px-8 rounded-2xl bg-background border-border focus:border-primary focus:ring-primary text-lg font-bold tracking-tight shadow-inner" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <Input placeholder="you@company.com" className="h-16 md:h-20 px-8 rounded-2xl bg-background border-border focus:border-primary focus:ring-primary text-lg font-bold tracking-tight shadow-inner" />
          </div>
          <div className="space-y-4">
            <label className="text-[10px] font-black text-foreground/60 uppercase tracking-[0.3em] ml-4 italic">Phone_WhatsApp *</label>
            <Input placeholder="+91 98765 43210" className="h-16 md:h-20 px-8 rounded-2xl bg-background border-border focus:border-primary focus:ring-primary text-lg font-bold tracking-tight shadow-inner" />
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <select 
                ...
                className="w-full h-16 md:h-20 px-8 rounded-2xl bg-background border border-border focus:border-primary focus:outline-none text-lg font-bold tracking-tight shadow-inner appearance-none cursor-pointer pr-16"
              >
        ...
        <div className="space-y-4">
          ...
          <Textarea 
            ...
            className="min-h-[150px] md:min-h-[180px] p-8 rounded-[1.5rem] md:rounded-[2rem] bg-background border-border focus:border-primary focus:ring-primary text-lg font-bold tracking-tight resize-none shadow-inner leading-relaxed" 
          />
        </div>

        <MagneticButton>
          <Button className="w-full h-20 md:h-24 rounded-2xl md:rounded-3xl bg-primary text-primary-foreground text-lg md:text-xl font-black shadow-[0_30px_60px_-15px_oklch(var(--primary)/0.4)] hover:bg-foreground hover:text-background transition-all duration-1000 group border-none uppercase tracking-widest">
