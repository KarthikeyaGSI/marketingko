...
export default function AboutPage() {
  return (
    <main className="pt-40 bg-black min-h-screen">
      <section className="py-40 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,102,255,0.05)_0%,transparent_70%)]" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center space-y-12">
            ...
            >
              ...
              <span className="text-[10px] font-black tracking-[0.8em] text-white uppercase">Operational Philosophy</span>
            </motion.div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
            <div className="space-y-8">
              ...
              <h3 className="text-4xl font-bold text-white tracking-tighter italic">Infrastructure First</h3>
            ...
            <div className="space-y-8">
              ...
              <h3 className="text-4xl font-bold text-white tracking-tighter italic">Live Telemetry</h3>
              <p className="text-xl text-muted-foreground font-medium tracking-tight leading-relaxed">
            ...
            <div className="space-y-8">
              ...
              <h3 className="text-4xl font-bold text-white tracking-tighter italic">Autonomous Growth</h3>
              <p className="text-xl text-muted-foreground font-medium tracking-tight leading-relaxed">
