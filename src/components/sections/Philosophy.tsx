      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
               ...
               {pillars.map((pillar, i) => (
                 <div key={i} className="flex items-start space-x-8 group">
                    <div className="w-12 h-12 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center flex-shrink-0 group-hover:bg-primary transition-colors duration-500">
                       <pillar.icon className="text-primary group-hover:text-white w-6 h-6 transition-colors" />
                    </div>
                    <div className="space-y-2">
                       <h4 className="text-2xl font-bold text-white tracking-tighter">{pillar.title}</h4>
          ...
          <div className="relative group">
            ...
            <div className="relative aspect-[4/5] rounded-[5rem] border border-white/5 bg-white/[0.01] backdrop-blur-3xl overflow-hidden p-16 flex flex-col justify-between group-hover:border-primary/20 transition-all duration-1000">
               <div className="flex justify-between items-start">
                  <div className="flex flex-col">
                    <span className="text-[10px] font-black tracking-[0.5em] text-white/20 uppercase">Operator ID</span>
                    <span className="text-xl font-bold text-white tracking-tighter">MK-FOUNDER.25</span>
                  </div>
                  <Fingerprint className="text-primary w-12 h-12" />
               </div>
               
               <div className="space-y-12">
                  <p className="text-3xl md:text-5xl font-medium text-white tracking-tighter leading-tight italic">
                    "Growth is a science of systems. We don't guess. We engineer."
                  </p>
                  <div className="flex items-center space-x-6">
                     <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-purple-600 opacity-20" />
                     <div className="space-y-1">
                        <p className="text-2xl font-bold text-white tracking-tighter">Karthikeya</p>
                        <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.4em]">Systems Architect & Founder</p>
                     </div>
                  </div>
               </div>
            </div>
